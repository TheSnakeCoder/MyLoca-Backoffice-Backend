...
export class ExternalApiService {
  ...
  async updateUser(userId: string, updateData: any) {
    return this.makeRequest('PUT', `/users/${userId}`, updateData);
  }
  ...
  async getUserFriends(userId: string, page?: number, limit?: number) {
    ...
    return this.makeRequest('GET', `/admin/users/${userId}/friends${queryString}`);
  }

  async getUserFriendRequests(userId: string) {
    return this.makeRequest('GET', `/admin/users/${userId}/friend-requests`);
  }
